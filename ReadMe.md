...
Pour garantir la resolution des modules, utilisez le PYTHONPATH. Executre dans le terminal dans l'odre :\
1) Entrainement complet : PYTHONPATH=src python scripts/run_train.py\
2) Generation des predictions : PYTHONPATH=src python scripts/run_predicts.py\
